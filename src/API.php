...
class API
{
    ...
    protected $fstream = 'wss://fstream.binance.com/ws/'; // /< Endpoint for establishing USD-M future websocket connections
    ...
    {
        return $this->useTestnet ? $this->streamTestnet :
        ($this->useFutures ? $this->fstream : $this->stream);
    }
